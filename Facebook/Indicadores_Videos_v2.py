...
while i<= 10:
    ...
    if i==0:
        ...
        while item2 <= len(owned_apps_p21):
            ...
            except(ValueError,KeyError,ZeroDivisionError,NameError,IndexError): 
                  desc=''
    ...
    if i==1:
        ...
        while item2 <= len(owned_apps_correo):
            ...
            if item2==len(owned_apps_correo):
                print(str(item2) + ' correo')
                break
            
    if i==2:
        token3 = resultadosprueba[2]['access_token']
