...
now = datetime.today()
PATH_LOG = '/home/ec2-pentaho/pentaho/unp/Instagram/pagina/audiencia/log/'
...
def sendMail(subject,message):
 	...
 	# Display an error message if something goes wrong.
 	    ...
 	    logging.info("Carga de Indicadores Pagina Audiencia")
 	return
...
def subir_drive(listasubir,hoja,name):
    try:        
        ...
        JSON_FILE = '/home/ec2-pentaho/pentaho/unp/Instagram/pagina/audiencia/cmsproyecto-1610655853990-aa4048eb3551.json'
        ...
        RANGE_NAME = 'Audiencia_Ciudad!A2'
        ...
        sendMail("[Instagram] I.Pagina",f"Ocurrio un error en la carga de indicadores pagina audiencia al sheet :"+name+" {err} ")
...
while i<= 6:
    try:
        api= 'https://graph.facebook.com/'+a[i][0]+'/insights?metric=audience_city&period=lifetime&access_token='+a[i][1]
        ...
        resultadosprueba_1=resultadosprueba[0]["values"][0]["value"]
         ...
         sendMail("[Instagram] I.Pagina",f"Ocurrio un error en la obtencion de indicadores pagina audiencia : " + f"{err} ")
         logging.error(f"Ocurrio un error al consultar : {err}", exc_info=True)
         print(f'Other error occurred: {err}')  # Python 3.6
    if i==0:
        item2=0
